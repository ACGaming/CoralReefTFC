...
public class CoralReef
{
    ...
    public static BlockCoral CORAL = (BlockCoral) new BlockCoral().setRegistryName("coral").setTranslationKey("coral");
    public static BlockReef REEF = (BlockReef) new BlockReef().setRegistryName("reef").setTranslationKey("reef");
